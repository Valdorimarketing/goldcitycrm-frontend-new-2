              ...
              <div v-if="!isSaleStatus" class="mb-6 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div v-if="selectedProduct" class="mb-4 p-3 bg-gray-50 dark:bg-gray-700 rounded">
                  <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="text-gray-600 dark:text-gray-300">{{ formatPrice(selectedProduct.price) }} TL</span>
                  </div>
                  ...
                  <div class="grid grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="newService.discount"
                        type="number"
                        class="form-input text-sm"
                        @input="calculateOffer"
                      />
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="text-sm text-gray-500 dark:text-gray-400">
                        Fiyat: {{ formatPrice(service.price) }} TL |
                        İndirim: {{ formatPrice(service.discount) }} TL |
                        Teklif: {{ formatPrice(service.offer) }} TL
                      </div>
                      <div v-if="service.note" class="text-sm text-gray-600 dark:text-gray-300 mt-1">
                        Not: {{ service.note }}
                      </div>

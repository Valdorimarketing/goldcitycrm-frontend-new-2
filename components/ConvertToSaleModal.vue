            ...
            <div v-if="show" class="relative transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-2xl transition-all sm:w-full sm:max-w-4xl">
              ...
              <div class="max-h-[60vh] overflow-y-auto p-6">
                ...
                <div v-else-if="products.length > 0">
                    ...
                    <div class="flex">
                      ...
                      <div class="ml-3">
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                          Aşağıdaki hizmetlerden satışa çevirmek istediklerinizi seçin. Seçtiğiniz hizmetler için otomatik olarak satış kaydı oluşturulacak.
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="ml-3 flex-1">
                          <div class="flex items-start justify-between">
                            <div>
                              ...
                              <p v-if="product.product.description" class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                  ...
                  <!-- Total Amount -->
                  <div v-if="selectedProductIds.length > 0" class="mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border-2 border-green-200 dark:border-green-800">
                    <div class="flex items-center justify-between">
              ...
              <div class="border-t dark:border-gray-700 px-6 py-4">
                <div class="flex justify-between items-center">
                  ...
                  <button
                    ...
                    :disabled="selectedProductIds.length === 0 || converting"
